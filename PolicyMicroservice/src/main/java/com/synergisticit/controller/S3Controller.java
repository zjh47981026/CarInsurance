...
public class S3Controller {
    ...
    public CompletableFuture<ResponseEntity<String>> deleteMultipleFiles(@RequestBody List<String> fileKeys) {
        return service.deleteMultipleFiles(fileKeys)
                .thenApply(unused -> ResponseEntity.ok("Files deleted successfully!"))
